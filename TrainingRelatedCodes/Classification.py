...
BATCH_SIZE = 8
LEARNING_RATE = 0.003
TRAIN_DATA_PATH = "./CustomClassification"
...
if __name__ == '__main__':
    ...
    if (train_mode == 1):
        ...
        model = torch.load(os.getcwd() + "\\drow.pt")
        model.to(device)
        ...
        for epoch in range(EPOCHS):
            ...
            accuracy_train = 100*total_correct / total_samples
            ...
            print(f"Epoch {epoch+1}/{EPOCHS} - Train accuracy: {accuracy_train}, Validation accuracy:{accuracy_val}")
